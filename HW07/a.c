...
public
	static RandomInputGenerator generator = new RandomInputGenerator();
public
	static GUIVisualization visualization = new GUIVisualization("line");
...
private
	static void processCommand(String line, StockDataManager manager)
	{
...
private
	static void performPerformanceAnalysis(StockDataManager manager, int size)
	{
		...
		// visualization.addDataPoint(0, size, (endTime - startTime) / size);
		...
		// visualization.addDataPoint(1, size, (endTime - startTime) / size);
		...
		// visualization.addDataPoint(2, size, (endTime - startTime) / size);

		System.out.println("Performance analysis done.");
